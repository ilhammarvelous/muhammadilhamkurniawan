                ...
                <div className="mt-16 flex flex-col lg:flex-row items-center gap-10">
                    ...
                    <div
                        ...
                        <p className="mt-4 text-slate-600 text-[16px] leading-[28px]">
                            Saya seorang Junior Fullstack Developer yang berbasis di Surabaya, Saya merupakan lulusan baru (Fresh Graduate) S1 Teknik Informatika dari Universitas 17 Agustus 1945 Surabaya dengan fokus utama pada pengembangan aplikasi web, mobile dan rekayasa perangkat lunak. Saya senang dalam mengembangkan proyek berbasis web dan mobile, menganalisis sistem serta membangun logika sisi server yang tangguh.
                        </p>
