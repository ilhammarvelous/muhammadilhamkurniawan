        ...
        <section className="pt-36 container mx-auto px-6">
            <div className="container">
                ...
                <div className="w-full self-center lg:w-1/2">
                    ...
                    <h2 className="font-medium text-slate-500 text-lg mb-9 lg:text-xl dark:text-slate-500">
                    ...
                    <div className="flex flex-wrap md:gap-2 gap-4">
                        <a href="#contact">
                            <button className="text-base bg-blue-400 font-semibold text-white py-3 px-6 rounded-xl 
                ...
                <div className="w-full self-end lg:w-1/2">
                    <div className="relative mt-10 lg:mt-0 flex justify-center lg:justify-end lg:-mt-10">
                        
                        {/* Animasi Naik Turun (Floating) menggunakan Motion.div */}
                        <motion.div 
                            animate={{
                                y: [0, -30, 0], // Bergerak pada sumbu Y: dari 0 ke -20px lalu balik ke 0
                            }}
                            transition={{
