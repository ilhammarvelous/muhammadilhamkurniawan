   ...
   useEffect(() => {
    ...
    return (
        <nav className={`w-full flex items-center transition-all duration-300
            ${
                isScrolled
                ? "fixed z-[9999] bg-white/50 backdrop-blur-md dark:bg-slate-100/10 top-0 left-0 shadow-[inset_0_-1px_0_0_rgba(0,0,0,0.2)]"
                                        ...
                                        <a
                                            ...
                                            className={`text-base font-medium py-2 px-3 mx-2 md:mx-1 flex rounded-full transition-all duration-300
                                                ...
                                                ${activeSection === nav.id 
                                                    ? "bg-blue-100 text-blue-400 font-bold" 
                                                    : "text-slate-700"
                                                }`}
                                        >
                                            {nav.title}
